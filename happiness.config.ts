...
export const HappinessConfig = {
    ...
    defaultBaseURL:
        (process.env.NEXT_PUBLIC_DEFAULT_BASE_URL as string) ||
        'https://slingshot.giving',
    /**
     * The platform description, used for SEO/metadata purposes.
     */
    description:
        (process.env.NEXT_PUBLIC_APP_DESCRIPTION as string) ||
        'A donation page platform',
    /**
     ...
     */
    favicon:
        (process.env.NEXT_PUBLIC_FAVICON as string) ||
        'https://fast.slingshot.fm/sling/logo/icons-bw/favicon.ico',
    /**
    ...
    fiscalSponsorMode:
        ((
            process.env.NEXT_PUBLIC_FISCAL_SPONSOR_MODE as string | undefined
     ...
     */
    fiscalSponsorName:
        (process.env.NEXT_PUBLIC_FISCAL_SPONSOR_NAME as string) ||
        'Fiscal Sponsor Name',
    /**
     * In fiscal sponsor mode, the name of the 501c3 organization that is the fiscal sponsor. This is used in receipts and disclaimers.
     */
    fiscalSponsorEIN:
        (process.env.NEXT_PUBLIC_FISCAL_SPONSOR_EIN as string) || '00-0000000',
    /**
     * Hide the "Powered by Happiness" text in the footer. :(
     */
    hidePoweredByHappiness:
        ((
            process.env.NEXT_PUBLIC_HIDE_POWERED_BY as string | undefined
     ...
     */
    tipDescription:
        (process.env.NEXT_PUBLIC_TIP_DESCRIPTION as string) ||
        'Slingshot Giving builds the tools that make it easy for creators to run fundraisers like this. If you appreciate our work, consider leaving a tip to help us enable more creators to raise money for impactful causes.',
