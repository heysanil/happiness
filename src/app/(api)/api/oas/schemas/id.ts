...
export const IDParameter: ParameterObject = {
    ...
    in: 'path',
    description:
        'The ID of the resource to retrieve. IDs are always 13-character alphanumeric strings prefixed with a 2-character resource type identifier and an underscore.',
    required: true,
    schema: {
        type: 'string',
