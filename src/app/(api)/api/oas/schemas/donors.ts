...
export const DonorProperties = (
    ...
    phone: {
        type: 'string',
        description:
            'The phone number of the donor, in [E.164](https://www.twilio.com/docs/glossary/what-e164) format.',
        nullable: true,
        example: '+14242452439',
        maxLength: 20,
    },
    anonymous: {
        type: 'boolean',
        description:
            "Whether the donor wishes to remain anonymous. If true, the donor's name should not be displayed publicly and should only be available to organization leaders.",
        default: false,
    },
    ...(readOnly ? timestamps : {}),
});

export const DonorRequired = [
    ...alwaysRequired,
    'email',
    'firstName',
    'lastName',
