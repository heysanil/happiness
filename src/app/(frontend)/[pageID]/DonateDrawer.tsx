...
import {
    ...
    openDonateDrawer,
    useDonateDrawerOpen,
} from '@frontend/[pageID]/donateDrawerStore';
...
import styles from 'src/app/(frontend)/[pageID]/DonateDrawer.module.scss';
...
/**
 * The single donate drawer for a page. Mounted once at the page level;
 * opened by any DonateButton trigger (or ?open=donate) via donateDrawerStore.
 */
export const DonateDrawer = ({ page }: { page: Page }) => {
    const params = useSearchParams();
    const router = useRouter();
    const drawerOpen = useDonateDrawerOpen();
    ...
    // Reset the shared open state when leaving the page
    useEffect(() => closeDonateDrawer, []);
