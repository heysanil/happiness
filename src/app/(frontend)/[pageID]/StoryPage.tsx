...
export const StoryPage: FC<{
    ...
    embed?: boolean;
}> = ({ page, recentDonations, embed = false }) => (
    <>
        {!embed && (
        ...
        <div className="flex flex-col gap-8 md:col-span-7 lg:col-span-2">
            {page.bannerType && page.bannerURL && (
                <div
                    className={`${styles.shallowPopup} rounded-[8px] overflow-clip`}
                >
                    <Banner
                ...
                <>
                    ...
                    <div className="flex flex-row justify-between">
                        <div className="flex flex-col gap-2">
                            <Text as="h2" kind="labelSmall">
                                Organized by
                            </Text>
                            <Text as="h3" kind="headingSmall">
                                {page.organizer}
                            </Text>
                        </div>
