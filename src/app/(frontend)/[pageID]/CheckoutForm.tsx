...
>(
    (
        { donation, onSuccess, returnUrl, onLoadingChange, onBillingChange },
        ref,
    ) => {
        ...
        return (
            ...
            >
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="flex justify-between">
                            ...
                            <Text kind="paragraphXSmall">
                                {formatCurrency(donation.amount, 2)}
                            </Text>
                        </div>
                        {donation.coverFees && (
                            <div className="flex justify-between">
                ...
                <div
                    style={{
                        display: expressCheckoutAvailable ? undefined : 'none',
                    }}
                >
                    <ExpressCheckoutElement
                ...
                {expressCheckoutAvailable && (
                    <div className="flex items-center gap-3">
                        <div
                            ...
                            style={{
                                background:
                                    'var(--pte-colors-borderOpaque, #e5e5e5)',
                            }}
                        />
                        <Text
                            kind="paragraphXSmall"
                            style={{
                                color: 'var(--pte-colors-contentTertiary, #6b7280)',
                            }}
                        >
                            Or pay with card
                        </Text>
